"""
TRAINING STAGE: Classical Augmentation Models
Trains all 6 models (CNN, LSTM, CNN-LSTM, ResNet, Transformer, SVM) on augmented features.
Generates model comparison visualizations and results.

Input: research_pipeline/data/classical_augmented_features.npz
Output: research_pipeline/results/augmentation/classical/
...
def train_classical_models(
    ...
    """Train all models on classical augmented features"""
    ...
    if not feature_path.exists():
        raise FileNotFoundError(
            ...
            f"  python generate_classical_augmented_data.py"
        )
    ...
    print("\n" + "=" * 80)
    print("CLASSICAL TRAINING STAGE COMPLETE")
    print("=" * 80)
    print(f"\nResults saved to:")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Train models on classical augmented features',
    )
