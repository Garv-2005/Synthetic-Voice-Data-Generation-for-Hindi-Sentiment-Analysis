...
from augmentation.vae_gan.generate_vae_augmented_data import generate_vae_augmented_data
from augmentation.vae_gan.train_vae_models import train_vae_models
...
def run_vae_pipeline(
    ...
    if stage in ('generation', 'both'):
        ...
        data_dir = base_dir / "data" / "vae_augmented_features.npz"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='VAE Augmentation Pipeline (Generation + Training)'
    )
    parser.add_argument(
        '--stage',
